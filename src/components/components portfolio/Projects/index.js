            ...
            <div className="projectsContent">
                ...
                <div className="project">
                    ...
                    <div className="project--description">
                        ...
                        <p>React, css, GitHub Pages</p>
                        <div className="project--description__buttons">
                            <a className='header--menu__contact' href="https://josuemartinezgonzalez.github.io/Agency-Landing-Page/" target="_blank">Ir <i> <BiLinkExternal/> </i></a>
                ...
                <div className="project">
                    ...
                    <div className="project--description">
                        ...
                        <p>React, css, GitHub Pages</p>
                        <div className="project--description__buttons">
                            <a className='header--menu__contact' href="https://josuemartinezgonzalez.github.io/Rick-Y-Morty-SPA/" target="_blank">Ir <i> <BiLinkExternal/> </i></a>
                ...
                <div className="project">
                    ...
                    <div className="project--description">
                        ...
                        <p>React, css, GitHub Pages</p>
                        <div className="project--description__buttons">
                            <a className='header--menu__contact' href="https://josuemartinezgonzalez.github.io/Frebbie/" target="_blank">Ir <i> <BiLinkExternal/> </i></a>
